...
export default function ItemExistsModal() {
  ...
  const state = {
    ...
    itemExistsPromiseResolver: useSelector(
      state => state.itemExistsPromiseResolver,
    ),
      ...
      <View
        ...
        <View style={[styles.padding]}>
          <Text style={[styles.text]}>
            {state.itemInOperation} already exists in destination.
          </Text>
        </View>
        <View style={[styles.divider]} />
        <View style={[styles.rowLayout, styles.mediumGap, styles.padding]}>
          <Pressable
