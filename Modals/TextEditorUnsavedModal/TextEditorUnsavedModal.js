...
export default function TextEditorUnsavedModal() {
  const state = {
    ...
    textEditorUnsavedPromiseResolver: useSelector(
      state => state.textEditorUnsavedPromiseResolver,
    ),
  };
  return (
    <Modal
      ...
      transparent={true}>
      <Pressable
        onPress={() => state.textEditorUnsavedPromiseResolver(0)}
      ...
      <View
        ...
        <View style={[styles.divider]} />
        <View style={[styles.rowLayout, styles.padding, styles.mediumGap]}>
          <Pressable
            onPressIn={() => {
              state.textEditorUnsavedPromiseResolver(0);
            }}
            style={[styles.pill, styles.centered, styles.wide, styles.padding]}>
