      ...
      <Animated.View
        ...
        <View
          ...
          <View style={[styles.rowLayout, styles.padding]}>
            <View style={[styles.rowLayout, styles.bigGap, styles.wide]}>
              <MaterialIcon name="heart" color="#FF5252" />
              <Text style={[styles.text, styles.headingText]}>Favourites</Text>
            </View>
            <Text
              style={[
                styles.text,
              ...
              onPressIn={() => {
                if (
                  state.favouriteItems.find(
                    item => item.path == state.tabs[state.currentTab]['path'],
                  ) == undefined
                ) {
                  dispatch({
                    type: 'ADDFAVOURITEITEM',
                    payload: {
                      name: state.tabs[state.currentTab]['path']
                        .split('/')
                        .pop(),
