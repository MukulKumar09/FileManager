  ...
  return (
    <Modal
      ...
      <View
        ...
        <View style={[styles.bigGap, styles.padding, {width: '100%'}]}>
          {Boolean(alreadyExists) && (
            <Text style={[styles.text, styles.smallText]}>Already exists!</Text>
          )}
          <View
            style={[
              styles.rowLayout,
            ...
            <TextInput
              ...
              onChangeText={text => {
                for (
                  let i = 0;
                  i < state.cache[state.tabs[state.currentTab]['path']].length;
                  i++
                ) {
                  if (
                    text == state.itemInOperation ||
                    state.cache[state.tabs[state.currentTab]['path']][i][
                      'name'
                    ] == text
                  ) {
                    setAlreadyExists(1);
        ...
        <View style={[styles.rowLayout, styles.padding, styles.bigGap]}>
          <Pressable
            ...
            style={[styles.pill, styles.wide, styles.centered, styles.padding]}>
          ...
          <Pressable
            ...
            <Text style={[styles.text, alreadyExists && styles.textDisabled]}>
              Done
            </Text>
          </Pressable>
        </View>
